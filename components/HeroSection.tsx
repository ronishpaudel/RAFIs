...
export function HeroSection() {
  return (
    <section className="relative bg-green-600 h-screen flex items-center">
      <div className="max-w-[1920px] w-full mx-auto px-4 sm:px-6 lg:px-8 z-20 relative">
        <div className="max-w-3xl">
          ...
          <a
            href="/products"
            className="inline-block text-white bg-green-700 dark:bg-green-700 px-6 py-3 rounded-full font-semibold hover:bg-green-800 dark:hover:bg-green-600 transition duration-300 text-sm sm:text-base shadow-lg dark:shadow-md"
          >
